...
textLandNumber.addEventListener('keyup',()=>{
    textFieldValiation(textLandNumber,'^[0](11|21|23|24|25|26|27|31|32|33|35|36|37|38|41|45|47|51|52|54|55|57|63|65|66|67|81)[0-9]{7}$','employee','land no')
})
...
textfullname.addEventListener('keyup',()=>{
    ...
    generateCaliingNameValues(textfullname)
...
textNote.addEventListener('keyup',()=>{
    ...
    textFieldValiation(textNote,'^.*$','employee','text note')
})
...
textDateOfBirth.addEventListener('change',()=>{
    dateFieldValiation(textDateOfBirth,'','employee','dob')
})
